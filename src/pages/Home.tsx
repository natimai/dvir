        ...
        <Container maxWidth="lg">
          <HeroContent>
            ...
            >
              ...
              >
                פייטן באר שבע וחזן לבר מצווה מקצועי
              </Typography>
            </motion.div>
            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ p: 3 }}>
                ...
                <Typography paragraph>
                  כבר למעלה מ-14 שנים שאנחנו מביאים את הקסם של המוזיקה היהודית המסורתית לאירועי בר מצווה בבאר שבע והדרום. המסע שלנו התחיל מאהבה עמוקה למסורת ולפיוטים, והתפתח לכדי חוויה מוזיקלית ייחודית המשלבת בין העבר להווה.
                </Typography>
                <Typography paragraph>
                  הצוות שלנו מורכב מפייטנים וחזנים מקצועיים, שכל אחד מהם מביא איתו ניסיון עשיר בכישרון ייחודי בפייטנות מרוקאית, פיוטים ספרדיים וחזנות ירושלמית. יחד, אנחנו יוצרים הרמוניה מושלמת שמתאימה לכל אירוע בר מצווה ולכל קהל.
                </Typography>
              </Box>
            </Grid>
          </Grid>
