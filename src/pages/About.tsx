            ...
            <Grid item xs={12} md={6}>
              ...
              >
                <Typography variant="h2" gutterBottom>
                  דביר דלויה - פייטן באר שבע וחזן לבר מצווה מקצועי
                </Typography>
                <Typography variant="h5" gutterBottom color="primary">
                  14 שנות ניסיון בפייטנות מרוקאית וחזנות ירושלמית
                </Typography>
                <Typography paragraph>
                  דביר דלויה הוא פייטן באר שבע וחזן לבר מצווה מקצועי המתמחה בפייטנות מרוקאית, פיוטים ספרדיים וחזנות ירושלמית. כבעל תואר ראשון בחינוך מיוחד, דביר משלב את כישוריו החינוכיים עם אהבתו למוזיקה ולמסורת, ומעניק חוויה ייחודית ומעשירה לכל אירוע בר מצווה בבאר שבע והדרום.
                </Typography>
                <Typography 
                  variant="h6" 
                  sx={{ 
