...
const galleryImages = [
  { src: 'gallery/orenk-140 Large.jpeg', alt: 'פייטן באר שבע דביר דלויה שר בהופעה חיה עם מיקרופון, מלא באנרגיה ותשוקה למוזיקה' },
  { src: 'gallery/orenk-139 Large.jpeg', alt: 'חזן לבר מצווה דביר דלויה מופיע באירוע משפחתי, מלווה בכלי נגינה מסורתיים' },
  { src: 'gallery/orenk-134 Large.jpeg', alt: 'פייטן מקצועי דביר דלויה בפגישת היכרות עם לקוחות, מסביר על שירותי פייטנות בבאר שבע' },
  { src: 'gallery/orenk-98 Large.jpeg', alt: 'דביר דלויה מלמד נער בר מצווה, מדריך אותו בקריאה בתורה ובפיוטים מרוקאיים' },
  { src: 'gallery/orenk-97 Large.jpeg', alt: 'פייטן לבר מצווה דביר דלויה בחזרה לקראת אירוע, עובד על בחירת רפרטואר מוזיקלי' },
