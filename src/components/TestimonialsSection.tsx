...
const testimonials = [
  {
    content: "לימד את אחיין שלי לעלייה לתורה, הילד קרא מדהים! בנוסף צוות הניגון ודביר עשו לנו שמח מאוד, מומלץ מאוד!",
    name: "רותם לב",
    event: "בר מצווה"
  },
  {
    content: "דביר המורה הכי טוב שיש ממליץ בזכותו הצלחתי בעליה לתורה שלי",
    name: "שוהם פימנטה",
    event: "בר מצווה"
  },
  {
    content: "הייתי באירוע עליה לתורה שבו דביר ניהל הטקס והתפילה. הוא שר נהדר וגם כאלה שלא מורגלים להגיע לבתי כנסת התרגשו. מומלץ",
    name: "מרטין בן דור",
    event: "בר מצווה"
  }
];
